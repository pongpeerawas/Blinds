...
?>
   <div class="col-sm-6 col-md-3">
      ...
      <img src="<?php echo base_url('assetAmdin/img/') ?> <?php if($row->Pro_Pic != ''){  echo $row->Pro_Pic; } else { echo 'no_image.png'; } ?>" alt="<?php echo $row->Pro_Name;?>" class="img-responsive" style="height:200px">
      ...
      <p>$ <?php echo $row->Pro_Price;?> </p>
        ...
        <div class="input-group" style="width:120px">
                ...
                <div class="col-md-1" style="float:right;margin-left:-5px">
                    <button class="btn btn-primary add_to_cart" type="button" product_id="<?php echo $row->Pro_Id;?>">Buy</button>
                  </div>

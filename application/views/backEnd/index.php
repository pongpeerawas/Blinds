...
<head>
        <title>Blinds Store</title><meta charset="UTF-8" />
    ...
    <body>
        ...
        <div id="loginbox">
            <form id="loginform" class="form-vertical"  method="post"  action="check_login.php">
				 <div class="control-group normal_text"> <h3><img src="assetAdmin/img/icons/32/home.png"  /></h3></div>
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"> </i></span> <input type="text" name="txtUsername" class="form-control" id="txtUsername" placeholder="Username">
                ...
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_ly"><i class="icon-lock"></i></span>  <input type="password" name="txtPassword" class="form-control" id="txtPassword" placeholder="Password">
                        </div>
                    </div>
                </div>

			...
			if(qty == 0){
				...
				var dataString  = { Pro_Id  : Pro_Id , qty : qty };
					...
					$.ajax({
						...
						type: "POST",
						url: "<?php echo base_url();?>fontEnd/Cart",
						data: dataString,
						dataType: "json",
						cache		: false,
			...
			if(notif == true){
				...
				var dataString  = { Pro_Id  : Pro_Id , qty : qty };
					...
					$.ajax({
						...
						type: "POST",
						url: "<?php echo base_url();?>fontEnd/Cart/update",
						data: dataString,
						dataType: "json",
						cache: false,
						success: function(data){
		...
		$(".delete_cart").click(function(){
			...
			if(x == true){
				...
				$.ajax({
						...
						type: "POST",
            url: "<?php echo base_url('fontEnd/Cart/delete') ?>",
						// url: "<?php echo base_url();?>fontEnd/Cart/delete",
						data: dataString,
						dataType: "json",
						cache		: false,
		...
		$(".empty_cart").click(function(){
			...
			if(x == true){
				...
				$.ajax({
						...
						type: "POST",
						url: "<?php echo base_url();?>fontEnd/Cart/empty_cart",
						data: dataString,
						dataType: "json",
						cache		: false,
						success: function(data){
